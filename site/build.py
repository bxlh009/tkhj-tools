...
def nav(active="home"):
    ...
    out.append('<button class="theme-toggle" aria-label="Toggle dark mode" data-theme-toggle><svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="5"/></svg></button>')
